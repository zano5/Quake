...
/**
 * Created by ProJava on 8/26/2016.
 */
public class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            //double mag, String city, String date
            ...
            {
                JSONObject featureObject = featureArray.getJSONObject(x);
                JSONObject propertyObject = featureObject.optJSONObject( "properties");
                String mag = propertyObject.optString("mag");
                String url = propertyObject.optString("url");
                /*String time = propertyObject.optString("time");
                Long t = Long.parseLong(time);
                Date dateObject = new Date(t);
                SimpleDateFormat dateFormat = new SimpleDateFormat("MMM DD, yyyy");
                String dateToDisplay = dateFormat.format(dateObject);*/

                Long data = propertyObject.optLong("time");
                Date dateObject = new Date(data);
                SimpleDateFormat dateFormat = new SimpleDateFormat("MMM DD, yyyy");
                String dateToDisplay = dateFormat.format(dateObject);
                SimpleDateFormat timeFormat = new SimpleDateFormat("hh:mm a");
                String timeToDisplay = timeFormat.format(data);
                String place = propertyObject.optString( "place");

                earthquakes.add(new Earthquake(Double.parseDouble(mag),place,dateToDisplay,timeToDisplay,url));
            }
